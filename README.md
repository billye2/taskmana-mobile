...
npm run test:unit   # node:test unit tests for the model logic (18 tests)
npm run test:e2e    # Playwright: loads the real extension; e2e + axe a11y + visual regression (18 tests)
